...
async function seed() {
  ...
  const adminRole = await prisma.role.create({
    data: {
      ...
      permissions: { create: ['dashboard', 'users', 'roles', 'clients', 'purchases', 'sales', 'reports'].map(m => ({ module: m })) }
    }
  });
  ...
  // Clients
  const clientsData = [
    { name: 'Ana María López', cedula: '4521332', department: 'Dirección General', position: 'Directora General', category: 'DIRECTIVO', email: 'ana.lopez@empresa.com', phone: '0981-555-001' },
    { name: 'Roberto Giménez', cedula: '3215887', department: 'Finanzas', position: 'Gerente Financiero', category: 'GERENTE', email: 'roberto.gimenez@empresa.com', phone: '0981-555-002' },
    { name: 'Claudia Vera', cedula: '5102443', department: 'Recursos Humanos', position: 'Jefa de RRHH', category: 'JEFE_DE_AREA', email: 'claudia.vera@empresa.com', phone: '0981-555-003' },
    { name: 'Marcos Villalba', cedula: '4887221', department: 'TI', position: 'Analista de Sistemas', category: 'ANALISTA', email: 'marcos.villalba@empresa.com', phone: '0981-555-004' },
    { name: 'Laura Cabrera', cedula: '6334109', department: 'Contabilidad', position: 'Analista Contable', category: 'ANALISTA', email: 'laura.cabrera@empresa.com', phone: '0981-555-005' },
    { name: 'Diego Paredes', cedula: '5776002', department: 'Ventas', position: 'Asistente Comercial', category: 'ASISTENTE', email: 'diego.paredes@empresa.com', phone: '0981-555-006' },
    { name: 'Sofía Riquelme', cedula: '7001554', department: 'Administración', position: 'Asistente Administrativa', category: 'ASISTENTE', email: 'sofia.riquelme@empresa.com', phone: '0981-555-007' },
    { name: 'Juan Ortiz', cedula: '3998776', department: 'Operaciones', position: 'Operador de Planta', category: 'OPERARIO', email: 'juan.ortiz@empresa.com', phone: '0981-555-008' },
    { name: 'Patricia Núñez', cedula: '4123880', department: 'Logística', position: 'Operadora Logística', category: 'OPERARIO', email: 'patricia.nunez@empresa.com', phone: '0981-555-009' },
    { name: 'Fernando Acosta', cedula: '8200115', department: 'TI', position: 'Practicante de Desarrollo', category: 'PRACTICANTE', email: 'fernando.acosta@empresa.com', phone: '0981-555-010' },
    { name: 'Gabriela Domínguez', cedula: '2990334', department: 'Marketing', position: 'Gerente de Marketing', category: 'GERENTE', email: 'gabriela.dominguez@empresa.com', phone: '0981-555-011' },
    { name: 'Ramón Escobar', cedula: '3445667', department: 'Mantenimiento', position: 'Técnico Contratista', category: 'CONTRATISTA', email: 'ramon.escobar@empresa.com', phone: '0981-555-012' }
  ];
  const clients = [];
